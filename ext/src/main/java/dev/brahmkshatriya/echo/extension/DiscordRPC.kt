...
open class DiscordRPC : ExtensionClient, LoginClient.WebView, TrackerClient,
    ...
    companion object {
        ...
        private const val PLAY_IMG = "https://echorpc.pages.dev/Echo.gif"
        private const val PAUSE_IMG = "https://echorpc.pages.dev/Pausec.png"
        private const val EMPTY_IMG = "https://echorpc.pages.dev/EchoF.png"
    }
